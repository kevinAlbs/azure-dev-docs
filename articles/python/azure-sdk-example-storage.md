...
In this article, you learn how to use the Azure management libraries in a Python script to provision a resource group that contains an Azure Storage account and a Blob storage container. ([Equivalent Azure CLI commands](#for-reference-equivalent-azure-cli-commands) are given later in this article.)
